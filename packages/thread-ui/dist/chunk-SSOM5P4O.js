...
// ../../node_modules/.pnpm/monaco-editor@0.56.0/node_modules/monaco-editor/esm/vs/base/common/functional.js
...
(function(Event2) {
  ...
  function latch(event, equals4 = (a, b) => a === b, disposable) {
    let firstCall = true;
    let cache;
...
// ../../node_modules/.pnpm/monaco-editor@0.56.0/node_modules/monaco-editor/esm/vs/base/common/objects.js
...
function equals3(a, b, ignoreCase) {
...
// ../../node_modules/.pnpm/monaco-editor@0.56.0/node_modules/monaco-editor/esm/vs/base/common/date.js
var safeIntl = {
...
var TextReplacement = class _TextReplacement {
  ...
  static delete(range2) {
    return new _TextReplacement(range2, "");
  }
  ...
  removeCommonPrefix(text) {
    ...
    return new _TextReplacement(range2, newText);
  }
...
var StringReplacement = class _StringReplacement extends BaseStringReplacement {
  ...
  static replace(range2, text) {
    return new _StringReplacement(range2, text);
  }
  equals(other) {
  ...
  slice(range2, rangeInReplacement) {
    return new _StringReplacement(range2, rangeInReplacement ? rangeInReplacement.substring(this.newText) : this.newText);
  }
};
...
export {
  ...
  EndOfLineSequence,
  GlyphMarginLane,
  HoverVerbosityAction2 as HoverVerbosityAction,
  IndentAction,
  InjectedTextCursorStops,
  InlayHintKind2 as InlayHintKind,
  InlineCompletionEndOfLifeReasonKind2 as InlineCompletionEndOfLifeReasonKind,
  InlineCompletionHintStyle2 as InlineCompletionHintStyle,
  ...
  NewSymbolNameTriggerKind2 as NewSymbolNameTriggerKind,
